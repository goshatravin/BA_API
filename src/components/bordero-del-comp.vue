...
<div class="content">
      <div class="content-block" id="bordero">
                    <div class="content-block-wrapp__title">
                         <p class="content-block__subtitle">Удаление</p>
                    </div>
                        <p class="content-block__text">
                     Метод удаления позволяет аннулировать расторгнутый договор в
                      целом, а также удалить конкретное застрахованное лицо из
                       договора. Передавать 
                     необходимо один из пяти обязательных параметров:  
                  <span class="yellow-line">policy_id, policy_guid, person_id, person_guid, ba_policy_id плюс дату 
                     расторжения договора: date_dissolution.</span>   
                        </p>
                        <div class="content-block__stuff">
                            <p class="content-block-stuff__item"><span class="content-block-stuff__itemspan">URL:</span>https://api.accidentlaw.ru/partner/v2/?method=removeData</p>
...
<script>
import myData from '../JSON/data_remove.json'
export default {
