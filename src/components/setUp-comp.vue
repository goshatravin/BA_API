...
<div class="content">
      <div class="content-block" id="bordero">
                    <div class="content-block-wrapp__title">
                         <p class="content-block__subtitle">Установить webhook</p>
                    </div>
                        <p class="content-block__text">
                     Позволяет установить URL на стороне Партнера, на который Сервис будет отправлять данные 
                     (в том числе документы) по мере их появления или изменения в АИС Балт Ассистанс.
                        </p>
                        <div class="content-block__stuff">
                            <p class="content-block-stuff__item"><span class="content-block-stuff__itemspan">URL:</span>https://api.accidentlaw.ru/partner/v2/?method=setWebHook</p>
                        ...
                        <div class="content-block__field">
                              <div class="content-block-category-short">
                                ...
                                <div class="content-block-filed__item-short">
                                        <p class="coutput-text">key</p>
                                        <p class="coutput-text">Ключ доступа</p>
                                        <p class="coutput-text">Уникальный идентификатор.</p>
                                        <p class="coutput-text">--------</p>
                                        <!--  -->
                                        <p class="coutput-text">fileNotificationChoice</p>
                                        <p class="coutput-text">text</p>
                                        <p class="coutput-text">Принимает значения в формате {file, notification}</p>
                                        <p class="coutput-text">Принимает в себя один из трех параметров: file, notification или оба параметра сразу. Отправление файлов, уведомление о том, что файлы можно скачать, оба условия сразу</p>
                                        <!--  -->
                                        <p class="coutput-text">link</p>
                                        <p class="coutput-text">http://test-parser.com/</p>
                                        <p class="coutput-text">Адрес, принимающий запросы</p>
                                        <p class="coutput-text">--------</p>
                            </div>
                        </div>
                        </div>
                        <!--  -->
                           <div class="codeoutput">
                            <div class="codeoutput__item item1">
                                    ...
                                    <p class="code">
                                        &lt;form action="https://api.accidentlaw.ru/partner/v2/?method=setWebHook" method="post">
